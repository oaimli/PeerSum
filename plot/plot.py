...
def plot_radar_chart():
    ...
    ax.plot(angles, [35.10, 80.17, 90.87, 42.4, 35.10], linewidth=1.5, linestyle='solid', label="PeerSum-RC")
    ax.plot(angles, [28.65, 77.67, 90.31, 41.5, 28.65], linewidth=1.5, linestyle='solid', label="PeerSum-ALL")
    ax.plot(angles, [22.75, 63.55, 79.34, 26.5, 22.75], linewidth=1.5, linestyle='solid', label="WikiSum")
    ax.plot(angles, [23.49, 66.10, 82.01, 39.8, 23.49], linewidth=1.5, linestyle='solid', label="Multi-News")
    ax.plot(angles, [5.25, 37.62, 65.27, 24.6, 5.25], linewidth=1.5, linestyle='solid', label="WCEP")
    ax.plot(angles, [44.09, 86.54, 96.40, 34.3, 44.09], linewidth=1.5, linestyle='solid', label="Multi-XScience")
...
if __name__=="__main__":
    plot_summarization_results_bar_chart()