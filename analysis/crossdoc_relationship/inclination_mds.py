...
from utils.evaluation import rouge, bert_score_similarity
...
def bert_score(source_documents, summaries):
    ...
    for c, s in zip(source_documents, summaries):
        bert_similarities = []
        for d in c:
            bert_similarities.append(bert_score_similarity(d, s, scorer)["f"])
