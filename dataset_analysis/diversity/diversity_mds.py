...
if __name__ == "__main__":
    print("PeerSum")
    source_documents, summaries = loading_peersum(including_author=True, including_abstract=True, including_public=True)
    count_all = len(summaries)
    ...
    source_documents, summaries = loading_mds(
        "../../../preparing_data/", "multinews_lemma_stop")
    count_all = len(summaries)
    indexes = range(count_all)
    ...
    print("WCEP")
    source_documents, summaries = loading_mds(
        "../../../preparing_data/", "wcep_lemma_stop")
    count_all = len(summaries)
    indexes = range(count_all)
    target_indexes = random.sample(indexes, 1000)
    source_documents_tmp = []
    ...
    source_documents, summaries = loading_mds(
        "../../../preparing_data/", "multixscience_lemma_stop")
    count_all = len(summaries)
    indexes = range(count_all)
    ...
    print("Wikisum")
    source_documents, summaries = loading_mds(
        "../../../preparing_data/", "wikisum_lemma_stop")
    count_all = len(summaries)
    indexes = range(count_all)
