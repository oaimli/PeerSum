...
python mtsum_ram_from_primera.py  \
                ...
                --mode train \
                --model_path ../../result/MTSum_meta_ram_from_led_${GENERATION_LOSS}_${ACCEPTANCE_LOSS}_${RATING_LOSS}_${CONFIDENCE_LOSS}_${DOCUMENT_TYPE_LOSS}_${DATASET_NAME}_${MAX_LENGTH_INPUT}_${MAX_LENGTH_TGT}/ \
