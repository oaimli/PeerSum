...
def loading_peersum(folder="../../peersum", including_public=True, including_author=True, including_abstract=True):
    print("loading peersum")
    papers = []
    with jsonlines.open(folder + "/crawling_data/data/peersum_all.json", "r") as reader:
        for paper in reader:
            papers.append(paper)
    clusters = []
    for paper in papers:
...
def prepare_peersum_with_disagreements(folder="../../peersum"):
    print("loading peersum")
    papers = []
    with jsonlines.open(folder + "/crawling_data/data/peersum_all.json", "r") as reader:
        for paper in reader:
